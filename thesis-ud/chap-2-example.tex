...
\multicolumn{1}{c|}{$B_a = \dfrac 1 2$} & 
\multicolumn{2}{c|}{$B_b = 0.9$ (max)} & 
\multicolumn{1}{c|}{$B_y = \dfrac 1 2 \times 0.9$} \\ \thickhline
\backslashbox{\textbf{query path}}{\textbf{document path}} & 
\multicolumn{1}{c|}{$^3 a$} & 
\multicolumn{1}{c|}{$^4 b$} & 
\multicolumn{1}{c|}{$^5 b$} & 
\multicolumn{1}{c|}{$^6 y$} \\ \thickhline
$^1 a$ & & & \multicolumn{1}{c|}{$\dfrac 1 2 \times 0.9$} & \multicolumn{1}{c|}{$\dfrac 1 2 \times 0.9$}\\ \hline
$^3 a$ & \multicolumn{1}{c|}{$\dfrac 1 2$} & \multicolumn{1}{c|}{$\dfrac 1 2 \times 0.9$} & & \\ \hline
\end{tabular}
...
\begin{tabular}{|c"D{.}{}{2.5}|D{.}{}{2.5}|D{.}{}{2.5}|D{.}{}{2.5}|}
\hline
\textbf{current score} & \multicolumn{4}{c|}{$0.9 + 0.45 = 1.35$}\\ \thickhline
\textbf{bound variable} & 
\multicolumn{1}{c|}{$B_a = \dfrac 1 2 \times 0.9$ (max)} & 
...
\multicolumn{1}{c|}{$^6 y$} \\ \thickhline
$^1 a$ & & & \multicolumn{1}{c|}{$\dfrac 1 2 \times 0.9$} & \multicolumn{1}{c|}{$\dfrac 1 2 \times 0.9$}\\ \hline
$^3 a$ & \multicolumn{1}{c|}{$\dfrac 1 2$} & \multicolumn{1}{c|}{$\dfrac 1 2 \times 0.9$} & & \\ \hhline{="="="="="}
$^4 b$ & \multicolumn{1}{c|}{$\dfrac 1 2 \times 0.9$} & \notableentry & \notableentry & \\ \hline
\end{tabular}
\renewcommand{\arraystretch}{1}
\end{center}
...
\begin{tabular}{|c"D{.}{}{2.5}|D{.}{}{2.5}|D{.}{}{2.5}|D{.}{}{2.5}|}
\hline
\textbf{current score} & \multicolumn{4}{c|}{$1.35 + 0.45 = 1.8$}\\ \thickhline
\textbf{bound variable} & 
\multicolumn{1}{c|}{$B_a = 0$} & 
\multicolumn{2}{c|}{$B_b = 0$} & 
\multicolumn{1}{c|}{$B_y = \dfrac 1 2 \times 0.9$ (max)} \\ \thickhline
\backslashbox{\textbf{query path}}{\textbf{document path}} & 
\multicolumn{1}{c|}{$^3 a$} & 
\multicolumn{1}{c|}{$^4 b$} & 
\multicolumn{1}{c|}{$^5 b$} & 
...
$^3 a$ & \multicolumn{1}{c|}{$\dfrac 1 2$} & \multicolumn{1}{c|}{$\dfrac 1 2 \times 0.9$} & & \\ \hhline{="="="="="}
$^4 b$ & \multicolumn{1}{c|}{$\dfrac 1 2 \times 0.9$} & \notableentry & \notableentry & \\ \hhline{="="="="="}
$^2 x$ & \notableentry & \notableentry & \notableentry & \multicolumn{1}{c|}{$\dfrac 1 2 \times 0.9$} \\ \hline
\end{tabular}
\renewcommand{\arraystretch}{1}
\end{center}
