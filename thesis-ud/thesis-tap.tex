...
\title[A Novel Similarity-Search Engine for Mathematical Content in LaTeX Markup]{A Novel Similarity-Search Method for Mathematical Content in \LaTeX \ Markup and Its Implementation}
\author[Wei Zhong]{Wei Zhong}
\type{thesis}
\degree{Master of Science}
\majorfieldtrue\majorfield{Electrical and Computer Engineering}
\degreedate{Summer 2015}
